...
router.post("/", (0, validation_1.validate)(subcategory_2.createSubcategorySchema), (0, catchAsync_1.catchAsync)(subcategory_1.createSubcategory));
...
router.put("/:id", (0, validation_1.validate)(subcategory_2.updateSubcategorySchema), (0, catchAsync_1.catchAsync)(subcategory_1.updateSubcategory));
